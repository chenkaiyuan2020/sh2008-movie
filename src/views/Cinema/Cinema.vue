<template>
  <div>
    <header>
      <div class="left">
       <router-link to="../City" tag="li" active-class="active" class="city">
          <span>北京</span>
  ...
  <div class="cinema-list-wrap">
    <ul class="cinema-list">
     <li class="cinema-list-item"   v-for="(item,index) in cinemas" :key="index">
        <a href="javascript:;">
          <div class="text_left">
          ...
          <div class="text_right">
            <div>
            <i class="icon">￥</i>
            <span class="pay">{{item.lowPrice/100}}</span>  
